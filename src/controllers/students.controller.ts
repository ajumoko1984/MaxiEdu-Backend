...
parentId
  ...
  async getStudent(req: ExpressRequest, res: Response) {
    try {
      ...
      if (!student) return ResponseHandler.sendErrorResponse({ res, code: HTTP_CODES.NOT_FOUND, error: "Student not found" });
      return ResponseHandler.sendSuccessResponse({ res, code: HTTP_CODES.OK, message: "Student retrieved successfully", data: student });
    } catch (error: any) {
  ...
  async updateStudent(req: ExpressRequest, res: Response) {
    try {
      ...
      if (!updated) return ResponseHandler.sendErrorResponse({ res, code: HTTP_CODES.NOT_FOUND, error: "Student not found" });
      return ResponseHandler.sendSuccessResponse({ res, code: HTTP_CODES.OK, message: "Student updated successfully", data: updated });
    } catch (error: any) {
  ...
  async deleteStudent(req: ExpressRequest, res: Response) {
    try {
      ...
      if (!ok) return ResponseHandler.sendErrorResponse({ res, code: HTTP_CODES.NOT_FOUND, error: "Student not found" });
      return ResponseHandler.sendSuccessResponse({ res, code: HTTP_CODES.OK, message: "Student deleted" });
    } catch (error: any) {
